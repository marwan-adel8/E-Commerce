...
<div className="hidden md:flex gap-6 font-medium text-gray-700">
  ...
  <Link to="/Cart" className="hover:text-indigo-600 transition">Shop</Link>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              <a href="#" className="block text-gray-700 font-medium hover:text-indigo-600 transition">Shop</a>
              <a href="#" className="block text-gray-700 font-medium hover:text-indigo-600 transition">Categories</a>
